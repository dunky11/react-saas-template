...
import ConsecutiveSnackbarMessages from "../../universalComponents/ConsecutiveSnackbarMessages";
...
class Main extends PureComponent {
  ...
  selectDashboard = () => {
    ...
    if (!this.hasFetchedCardChart) {
      ...
      import("../../universalComponents/CardChart").then(Component => {
